...
>(({ className, ...props }, ref) => (
  <tr
    ref={ref}
    className={cn(
      "border-b border-neutral-700 transition-colors hover:bg-neutral-100/50 data-[state=selected]:bg-neutral-100 hover:bg-neutral-800 dark:data-[state=selected]:bg-neutral-800",
      className
    )}
    {...props}
  />
